...
var available_cards = [
	...
	{"id": "dodge", "name": "Evasion", "desc": "Dodge Chance +3%", "icon": "res://assets/ui/cards/card_speed.png"},
	{"id": "block", "name": "Bulwark", "desc": "Block Chance +5%", "icon": "res://assets/ui/cards/card_def.png"}
]
